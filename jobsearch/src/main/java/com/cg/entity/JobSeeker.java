...
public class JobSeeker {
	...
	public JobSeeker(int jobSeeker_Id, String jobSeeker_Name, String address, Long contact_No, String mail_ID,
			SkillSet skillSet,String location_preference, String username, String password) {
		super();
